...
export const IPC_CHANNELS = [
  ...
  { ns: "pairing", method: "list" },
  { ns: "pairing", method: "create" },
  { ns: "pairing", method: "revoke" },
  { ns: "pairing", method: "approve" },
  { ns: "pairing", method: "reject" },
  ...
  { ns: "harness", method: "detectSources" },
  { ns: "harness", method: "previewImport" },
  { ns: "harness", method: "installImport" },
  { ns: "harness", method: "discardImport" },
  ...
  { ns: "threads", method: "crewIntegration" },
  ...
  { ns: "threads", method: "setThreadProject" },
  ...
  { ns: "threads", method: "restore" },
  { ns: "threads", method: "purge" },
  { ns: "threads", method: "listTrashed" },
  { ns: "activity", method: "list" },
  { ns: "usage", method: "byDay" },
  { ns: "usage", method: "providerLimits" },
  ...
  { ns: "git", method: "prTemplate" },
  { ns: "git", method: "prDetail" },
  { ns: "git", method: "prEdit" },
  { ns: "git", method: "prComment" },
  ...
  { ns: "mergeQueue", method: "claimLane" },
  { ns: "mergeQueue", method: "listLanes" },
  { ns: "mergeQueue", method: "previewLane" },
  ...
  { ns: "simulator", method: "capabilities" },
  { ns: "simulator", method: "selectDeveloperDir" },
  { ns: "simulator", method: "listDevices" },
  { ns: "simulator", method: "status" },
  { ns: "simulator", method: "attach" },
  { ns: "simulator", method: "detach" },
  { ns: "simulator", method: "takeControl" },
  { ns: "simulator", method: "streamInfo" },
  { ns: "simulator", method: "retryStream" },
  { ns: "simulator", method: "sendInput" },
  { ns: "simulator", method: "accessibility" },
  { ns: "simulator", method: "scrollTo" },
  { ns: "simulator", method: "install" },
  { ns: "simulator", method: "launch" },
  { ns: "simulator", method: "openUrl" },
  { ns: "simulator", method: "screenshot" },
  { ns: "simulator", method: "startRecording" },
  { ns: "simulator", method: "stopRecording" },
