...
export function SettingsModal({
  ...
  }, [open, settings?.dailyBudgetUsd, settings?.orchestrationBudgetUsd, settings?.autoSettleAfterDays, settings?.prDiffCapLines, settings?.otel, settings?.uiScale, settings?.linearApiKey]);
