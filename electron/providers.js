...
const PROVIDERS = [
  ...
  },
  {
    ...
    modelInfo: [
      ...
      { id: "claude-fable-5-1-low", label: "Claude Fable 5.1 1M Low (NO ZDR)", description: "Claude Fable 5.1 1M Low (NO ZDR)", vendor: "Anthropic", contextTokens: 1000000 },
      { id: "claude-fable-5-1-medium", label: "Claude Fable 5.1 1M Medium (NO ZDR)", description: "Claude Fable 5.1 1M Medium (NO ZDR)", vendor: "Anthropic", contextTokens: 1000000 },
      { id: "claude-fable-5-1-high", label: "Claude Fable 5.1 1M (NO ZDR)", description: "Claude Fable 5.1 1M (NO ZDR)", vendor: "Anthropic", contextTokens: 1000000 },
      { id: "claude-fable-5-1-xhigh", label: "Claude Fable 5.1 1M Extra High (NO ZDR)", description: "Claude Fable 5.1 1M Extra High (NO ZDR)", vendor: "Anthropic", contextTokens: 1000000 },
      { id: "claude-fable-5-1-max", label: "Claude Fable 5.1 1M Max (NO ZDR)", description: "Claude Fable 5.1 1M Max (NO ZDR)", vendor: "Anthropic", contextTokens: 1000000 },
      { id: "claude-fable-5-1-thinking-low", label: "Claude Fable 5.1 1M Low Thinking (NO ZDR)", description: "Claude Fable 5.1 1M Low Thinking (NO ZDR)", vendor: "Anthropic", contextTokens: 1000000 },
      { id: "claude-fable-5-1-thinking-medium", label: "Claude Fable 5.1 1M Medium Thinking (NO ZDR)", description: "Claude Fable 5.1 1M Medium Thinking (NO ZDR)", vendor: "Anthropic", contextTokens: 1000000 },
      { id: "claude-fable-5-1-thinking-high", label: "Claude Fable 5.1 1M Thinking (NO ZDR)", description: "Claude Fable 5.1 1M Thinking (NO ZDR)", vendor: "Anthropic", contextTokens: 1000000 },
      { id: "claude-fable-5-1-thinking-xhigh", label: "Claude Fable 5.1 1M Extra High Thinking (NO ZDR)", description: "Claude Fable 5.1 1M Extra High Thinking (NO ZDR)", vendor: "Anthropic", contextTokens: 1000000 },
      { id: "claude-fable-5-1-thinking-max", label: "Claude Fable 5.1 1M Max Thinking (NO ZDR)", description: "Claude Fable 5.1 1M Max Thinking (NO ZDR)", vendor: "Anthropic", contextTokens: 1000000 },
      ...
      { id: "gemini-3.8-flash-low", label: "Gemini 3.8 Flash Low", description: "Gemini 3.8 Flash Low", vendor: "Google" },
      { id: "gemini-3.8-flash-medium", label: "Gemini 3.8 Flash Medium", description: "Gemini 3.8 Flash Medium", vendor: "Google" },
      { id: "gemini-3.8-flash-high", label: "Gemini 3.8 Flash High", description: "Gemini 3.8 Flash High", vendor: "Google" },
