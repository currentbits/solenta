...
describe("spendByDay and settings", () => {
  ...
  it("settings default null; set validates and persists without touching threads", () => {
    ...
    assert.deepEqual(store.getSettings(), { dailyBudgetUsd: null, orchestrationBudgetUsd: null, autoSettleAfterDays: 3, autoSettleOnMerge: true, mcpServers: [], defaultWorktree: false, defaultOrchestrate: false, defaultProvider: null, defaultModel: null, quotaFailover: [], onboardingSeen: false, updateChannel: null, notifications: true, feltEstimatePrompt: false, theme: "dark", agentsPanelDefault: "closed", agentsPanelRememberLast: false, stayAwake: "agent", quotaWaitAutoResume: true, confirmQuitWithActiveWork: true, guardrailsEnabled: true, prDiffCapLines: 400, agentProfiles: [], defaultOrchestratorProfileId: null, subagentPool: { defaultAlias: null, force: false, entries: [] }, otel: { endpoint: null, headers: {}, claudeMetrics: false }, uiScale: 1, linearApiKey: null, webhook: { url: null, onDone: true, onFailed: true, onWaiting: true } });
