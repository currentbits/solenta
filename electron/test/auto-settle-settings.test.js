...
describe("normalizeSettings autoSettleAfterDays", () => {
  it("absent key → default 3", () => {
    assert.deepEqual(normalizeSettings({}), {
      ...
      prDiffCapLines: 400,
      mcpServers: [],
      defaultWorktree: false, defaultOrchestrate: false, onboardingSeen: false, updateChannel: null, notifications: true, feltEstimatePrompt: false, theme: "dark", stayAwake: "agent", quotaWaitAutoResume: true, prDiffCapLines: 400, agentProfiles: [], subagentPool: { defaultAlias: null, force: false, entries: [] }, otel: { endpoint: null, headers: {}, claudeMetrics: false }, uiScale: 1, linearApiKey: null, webhook: { url: null, onDone: true, onFailed: true, onWaiting: true },
    });
